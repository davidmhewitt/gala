/* mutter-clutter-2.vapi generated by vapigen, do not modify. */

[CCode (cprefix = "Clutter", gir_namespace = "Clutter", gir_version = "2", lower_case_cprefix = "clutter_")]
namespace Clutter {
	...
	public class Actor : GLib.InitiallyUnowned, Atk.Implementor, Clutter.Animatable, Clutter.Container, Clutter.Scriptable {
		...
		[Version (deprecated = true, deprecated_since = "1.12", since = "1.0")]
		public void get_transformation_matrix (out unowned Clutter.Matrix matrix);
		[Version (since = "1.6")]
