...
[CCode (cprefix = "Cogl", gir_namespace = "Cogl-Path", gir_version = "2", lower_case_cprefix = "cogl_")]
namespace Cogl {
	...
	[CCode (cheader_filename = "cogl-path/cogl-path.h", cprefix = "COGL_PATH_FILL_RULE_", type_id = "cogl_path_fill_rule_get_type")]
